...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.CRequestChannel, MakePacket<C_RequestChannel>);
		_handler.Add((ushort)MsgId.CRequestChannel, PacketHandler.C_RequestChannelHandler);		
		_onRecv.Add((ushort)MsgId.CEnterChannel, MakePacket<C_EnterChannel>);
		_handler.Add((ushort)MsgId.CEnterChannel, PacketHandler.C_EnterChannelHandler);
	}
